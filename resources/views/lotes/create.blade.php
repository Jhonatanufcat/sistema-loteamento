...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Cadastrar Novo Lote</h1>
            </div>
            <div class="col-sm-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('quadra') is-invalid @enderror" 
                                       id="quadra" name="quadra" value="{{ old('quadra') }}" required>
                                @error('quadra')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('pos_x') is-invalid @enderror" 
                   id="pos_x" name="pos_x" value="{{ old('pos_x', 0) }}">
            @error('pos_x')
                <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('pos_y') is-invalid @enderror" 
                   id="pos_y" name="pos_y" value="{{ old('pos_y', 0) }}">
            @error('pos_y')
                <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('largura') is-invalid @enderror" 
                   id="largura" name="largura" value="{{ old('largura', 100) }}">
            @error('largura')
                <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('altura') is-invalid @enderror" 
                   id="altura" name="altura" value="{{ old('altura', 80) }}">
            @error('altura')
                <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
...
<!-- Continue com o botão submit... -->
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-save"></i> Cadastrar Lote
                    </button>
                </form>
            </div>
        </div>
